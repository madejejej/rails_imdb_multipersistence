...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { fname: @actor.fname, gender: @actor.gender, idactors: @actor.idactors, lname: @actor.lname, mname: @actor.mname, number: @actor.number }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { fname: @actor.fname, gender: @actor.gender, idactors: @actor.idactors, lname: @actor.lname, mname: @actor.mname, number: @actor.number }
    assert_redirected_to actor_path(assigns(:actor))
  end
